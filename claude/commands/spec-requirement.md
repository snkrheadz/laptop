---
description: Turn a one-line intent into a reviewable requirement.md (EARS acceptance criteria), then stop at the human gate
argument-hint: <intent text, or path to an intent.md>
---
