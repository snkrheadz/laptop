---
description: Scan a repository for agent-readiness (test automation / closed-loop verification / consistency) and emit an ROI-ranked backlog of spec intents — the front gate of the spec pipeline
argument-hint: <repo path, defaults to .>
---
